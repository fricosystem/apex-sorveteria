...
export default function HomePage() {
  ...
  // Debug logs
  useEffect(() => {
    console.log('[Page] State update:', { user, userData, authLoading, authReady, mounted })
  }, [user, userData, authLoading, authReady, mounted])
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      setApiError(err instanceof Error ? err.message : "Erro de conexão");
    }
  }, []);
  ...
  // ── Auth loading: show spinner until Firebase confirms auth state ──
  ...
  // ── Firebase responded: no user → show login page ──
  if (!user) {
    return <AuthPage />;
  }
          ...
          <div className="p-3 sm:p-4 md:p-6">
            {apiError ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <h2 className="text-lg font-semibold mb-1">Erro de conexão</h2>
