  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed left-[50%] z-50 grid w-full max-w-[calc(100%-1rem)] sm:max-w-[calc(100%-2rem)] sm:left-[50%] translate-x-[-50%] gap-4 rounded-t-2xl sm:rounded-lg border border-b-0 sm:border-b p-4 pb-safe sm:p-6 sm:pb-6 shadow-lg duration-200 sm:top-[50%] sm:translate-y-[-50%] bottom-0 sm:bottom-auto max-h-[92dvh] sm:max-h-[85vh] overflow-y-auto sm:max-w-lg",
          className
        )}
        {...props}
      >
